...
const std::unordered_map<std::string, CreatorFunction> get_supported_ops_fx() {
    return {
        ...
        {"aten.all.dim", op::translate_all},
        {"aten.all.dims", op::translate_all},
        ...
        {"aten.avg_pool1d.default", op::translate_avg_pool1d},
        ...
        {"aten.im2col.default", op::translate_im2col},
        ...
        {"aten.lerp.Scalar", op::translate_lerp},
        {"aten.lerp.Tensor", op::translate_lerp},
        ...
        {"aten.log_softmax.int", op::translate_log_softmax_fx},
        ...
        {"aten.max_pool1d.default", op::translate_max_pool1d},
        {"aten.max_pool1d_with_indices.default", op::translate_max_pool1d},
        ...
        {"aten.matmul.default", op::translate_1to1_match_2_inputs<opset10::MatMul>},
        ...
        {"aten.prelu.default", op::translate_1to1_match_2_inputs<opset10::PRelu>},
        ...
        {"aten.replication_pad1d.default", op::translate_replication_pad_nd},
        {"aten.replication_pad2d.default", op::translate_replication_pad_nd},
        {"aten.replication_pad3d.default", op::translate_replication_pad_nd},
        ...
        {"aten.softplus.default", op::translate_1to1_match_1_inputs<opset10::SoftPlus>},
        {"aten.softmax.int", op::translate_softmax_fx},
        ...
        {"aten.std.default", op::translate_std},
        {"aten.std.dim", op::translate_std},
        {"aten.std_mean.correction", op::translate_std_mean},
        {"aten.std_mean.default", op::translate_std_mean},
        {"aten.std_mean.dim", op::translate_std_mean},
