...
[`GGUFArchitectureAccuracy`](../tests/test_arch_accuracy.cpp) contains 24 small, nonzero F32
fixtures covering 20 verified architecture identifiers and experimental `hunyuan-moe`.
