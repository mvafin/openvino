...
// Typed RoPE configuration, replacing the raw ggml `op_params`/`rope_params` int32 array
...
public:
    ...
    // Byte offset of an input that is a ggml VIEW into a larger tensor (0 when the input
