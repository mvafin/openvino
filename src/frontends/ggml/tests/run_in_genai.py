...
#
# End-to-end: take a .gguf, convert it with the OpenVINO GGML frontend, IO-adapt it to the
...
#
# Steps:
#   # 1. prepare (dev OpenVINO that has the GGML frontend):
...
def main():
    ...
    p = sub.add_parser("prepare", help="convert gguf via GGML frontend + adapt + assemble genai dir")
