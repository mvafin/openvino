...
class TestConv2D(PytorchLayerTest):
    ...
    def create_model(self, weights_shape, strides, pads, dilations, groups, bias):
        ...
        class aten_convolution_mode(torch.nn.Module):
            ...
            def forward(self, x):
                return torch._convolution_mode(x, self.weight, self.bias, self.strides, self.pads, self.dilations, self.groups)
    ...
    @pytest.mark.parametrize("params",
                             [
                              ...
                              {'weights_shape': [1, 3, 3, 3], 'strides': [1, 1], 'pads': 'valid', 'dilations': [2, 2], 'groups': 1},
                              {'weights_shape': [3, 1, 1, 1], 'strides': [1, 1], 'pads': 'same', 'dilations': [1, 1], 'groups': 3},
                              {'weights_shape': [3, 1, 1, 1], 'strides': [1, 1], 'pads': 'valid', 'dilations': [1, 1], 'groups': 3},
                              {'weights_shape': [1, 3, 3, 3], 'strides': [2, 2], 'pads': 'valid', 'dilations': [1, 1], 'groups': 1},
                              {'weights_shape': [1, 3, 3, 3], 'strides': [2, 2], 'pads': 'valid', 'dilations': [2, 2], 'groups': 1},
                              {'weights_shape': [1, 3, 3, 3], 'strides': [2, 1], 'pads': 'valid', 'dilations': [1, 1], 'groups': 1},
                              {'weights_shape': [3, 1, 1, 1], 'strides': [2, 2], 'pads': 'valid', 'dilations': [1, 1], 'groups': 3},
                              {'weights_shape': [3, 1, 1, 1], 'strides': [2, 2], 'pads': 'valid', 'dilations': [2, 2], 'groups': 3},
                              {'weights_shape': [3, 1, 1, 1], 'strides': [2, 1], 'pads': 'valid', 'dilations': [1, 1], 'groups': 3},
                              {'weights_shape': [3, 1, 1, 1], 'strides': [1, 1], 'pads': 'same', 'dilations': [2, 1], 'groups': 3},
                              {'weights_shape': [3, 1, 1, 1], 'strides': [1, 1], 'pads': 'valid', 'dilations': [2, 1], 'groups': 3},
                              {'weights_shape': [3, 1, 1, 1], 'strides': [1, 1], 'pads': 'same', 'dilations': [2, 2], 'groups': 3},
                              {'weights_shape': [3, 1, 1, 1], 'strides': [1, 1], 'pads': 'valid', 'dilations': [2, 2], 'groups': 3},
                             ])
    @pytest.mark.parametrize("bias", [True, False])
    @pytest.mark.nightly
    @pytest.mark.precommit
    ...
    @pytest.mark.parametrize("params",
                             [
                              {'weights_shape': [1, 3, 3, 3, 3], 'strides': [1, 1, 1], 'pads': 'same', 'dilations': [1, 1, 1], 'groups': 1},
                              {'weights_shape': [1, 3, 3, 3, 3], 'strides': [1, 1, 1], 'pads': 'valid', 'dilations': [1, 1, 1], 'groups': 1},
                              {'weights_shape': [3, 1, 1, 1, 1], 'strides': [1, 1, 1], 'pads': 'same', 'dilations': [1, 1, 1], 'groups': 3},
                              {'weights_shape': [3, 1, 1, 1, 1], 'strides': [1, 1, 1], 'pads': 'valid', 'dilations': [1, 1, 1], 'groups': 3},
                              {'weights_shape': [1, 3, 3, 3, 3], 'strides': [2, 2, 1], 'pads': 'valid', 'dilations': [1, 1, 1], 'groups': 1},
                              {'weights_shape': [1, 3, 3, 3, 3], 'strides': [2, 2, 2], 'pads': 'valid', 'dilations': [1, 1, 1], 'groups': 1},
                              {'weights_shape': [1, 3, 3, 3, 3], 'strides': [2, 2, 2], 'pads': 'valid', 'dilations': [2, 2, 2], 'groups': 1},
                              {'weights_shape': [3, 1, 1, 1, 1], 'strides': [1, 1, 1], 'pads': 'same', 'dilations': [2, 1, 2], 'groups': 3},
                              {'weights_shape': [3, 1, 1, 1, 1], 'strides': [1, 1, 1], 'pads': 'valid', 'dilations': [2, 1, 2], 'groups': 3},
                             ])
    @pytest.mark.parametrize("bias", [True, False])
    @pytest.mark.nightly
    @pytest.mark.precommit
