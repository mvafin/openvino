...
class TestGather(CommonTFLayerTest):
    ...
    def create_gather_net(self, data_shape, indices, axis, batch_dims, use_mo_extractors, **kwargs):
    ...
    def test_gather(self, params, ie_device, precision, ir_version, temp_dir, use_mo_extractors):
        self._test(*self.create_gather_net(**params, ir_version=ir_version, use_mo_extractors=use_mo_extractors),
    ...
    @pytest.mark.nightly
    def test_gather_nightly(self, params, ie_device, precision, ir_version, temp_dir, use_mo_extractors):
        self._test(*self.create_gather_net(**params, use_mo_extractors=use_mo_extractors),
                   ie_device, precision, ir_version, temp_dir=temp_dir, use_mo_extractors=use_mo_extractors)
