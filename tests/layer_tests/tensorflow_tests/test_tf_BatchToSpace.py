...
class TestBatchToSpace(CommonTFLayerTest):
    def create_batch_to_space_net(self, in_shape, crops_value, block_shape_value, out_shape, ir_version, use_mo_extractors):
        """
    ...
    @pytest.mark.nightly
    def test_batch_to_space_4D(self, params, ie_device, precision, ir_version, temp_dir, use_mo_extractors):
        self._test(*self.create_batch_to_space_net(**params, ir_version=ir_version, use_mo_extractors=use_mo_extractors),
    ...
    @pytest.mark.nightly
    def test_batch_to_space_5D(self, params, ie_device, precision, ir_version, temp_dir, use_mo_extractors):
        self._test(*self.create_batch_to_space_net(**params, ir_version=ir_version, use_mo_extractors=use_mo_extractors),
                   ie_device, precision, ir_version, temp_dir=temp_dir, use_mo_extractors=use_mo_extractors)
