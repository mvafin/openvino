...
class TestBucketize(CommonTFLayerTest):
    def create_bucketize_net(self, input_shape, input_type, boundaries_size, ir_version, use_mo_extractors):
        """
    ...
    @pytest.mark.nightly
    def test_bucketize_float32(self, params, ie_device, precision, ir_version, temp_dir, use_mo_extractors):
        self._test(*self.create_bucketize_net(**params, ir_version=ir_version, use_mo_extractors=use_mo_extractors),
    ...
    @pytest.mark.nightly
    def test_bucketize_int32(self, params, ie_device, precision, ir_version, temp_dir, use_mo_extractors):
        self._test(*self.create_bucketize_net(**params, ir_version=ir_version, use_mo_extractors=use_mo_extractors),
                   ie_device, precision, ir_version, temp_dir=temp_dir, use_mo_extractors=use_mo_extractors)
