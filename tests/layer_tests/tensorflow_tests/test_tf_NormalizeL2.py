...
class TestNormalizeL2(CommonTFLayerTest):
    ...
    @staticmethod
    def create_normalize_l2_net_fusable(shape, axes, output_axes, ir_version, use_mo_extractors):
    ...
    @staticmethod
    def create_normalize_l2_net_non_fusable(shape, axes, output_axes, ir_version, use_mo_extractors):
        tf_net = TestNormalizeL2.build_tf_graph(shape, axes)
    ...
    def test_NormalizeL2_fusable_precommit(self, params, ie_device, precision, ir_version, temp_dir, use_mo_extractors):
        self._test(*self.create_normalize_l2_net_fusable(**params, ir_version=ir_version, use_mo_extractors=use_mo_extractors),
    ...
    @pytest.mark.precommit
    def test_NormalizeL2_non_fusable_precommit(self, params, ie_device, precision, ir_version, temp_dir, use_mo_extractors):
        self._test(*self.create_normalize_l2_net_non_fusable(**params, ir_version=ir_version, use_mo_extractors=use_mo_extractors),
    ...
    @pytest.mark.nightly
    def test_NormalizeL2_fusable(self, params, ie_device, precision, ir_version, temp_dir, use_mo_extractors):
        self._test(*self.create_normalize_l2_net_fusable(**params, ir_version=ir_version, use_mo_extractors=use_mo_extractors),
                   ie_device, precision, ir_version, temp_dir=temp_dir, use_mo_extractors=use_mo_extractors)
    ...
    @pytest.mark.nightly
    def test_NormalizeL2_non_fusable(self, params, ie_device, precision, ir_version, temp_dir, use_mo_extractors):
        self._test(*self.create_normalize_l2_net_non_fusable(**params, ir_version=ir_version, use_mo_extractors=use_mo_extractors),
                   ie_device, precision, ir_version,
                   temp_dir=temp_dir, use_mo_extractors=use_mo_extractors)
