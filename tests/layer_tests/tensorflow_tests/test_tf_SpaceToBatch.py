...
class TestSpaceToBatch(CommonTFLayerTest):
    def create_space_to_batch_net(self, in_shape, pads_value, block_shape_value, out_shape, ir_version, use_mo_extractors):
        """
    ...
    @pytest.mark.nightly
    def test_space_to_batch_4D(self, params, ie_device, precision, ir_version, temp_dir, use_mo_extractors):
        self._test(*self.create_space_to_batch_net(**params, ir_version=ir_version, use_mo_extractors=use_mo_extractors),
    ...
    @pytest.mark.nightly
    def test_space_to_batch_5D(self, params, ie_device, precision, ir_version, temp_dir, use_mo_extractors):
        self._test(*self.create_space_to_batch_net(**params, ir_version=ir_version, use_mo_extractors=use_mo_extractors),
                   ie_device, precision, ir_version, temp_dir=temp_dir, use_mo_extractors=use_mo_extractors)
